...
let CharacterNavItem: FunctionComponent<{ cId: Id<GID.Character>, active: boolean, chain: Chain, navigate: (s: string) => void, overlay?: boolean }> = (p) => {
    ...
    return (
        <div
            ...
            <NavLink to={location.pathname.replace(/\/\d+\/items/, `/${p.cId}/items`)}
                className={({ isActive }) =>
                    ...
                    <FloatingButtonRow
                        buttons={[{
                            onClick: () => {
                                ...
                                p.navigate(location.pathname.replace(/\/\d+\/items/, `/${p.chain.characterList[newCharNum]}/items`))
                            },
                            icon: "trash"
                        }]}
        ...
        <div className="wrapper">
            ...
            <div className="greedy-flex-item scrolling" >
                <div className="wrapper-2 extra-roomy-cell vspaced" >
                    <ItemNavigationBar chain={chain} jumperId={charId} />
